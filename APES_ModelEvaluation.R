...
if (T) {
  ...
  ggsave(plot = plt, filename = str_c("ModelEvalutation/scatterplot_true_pred.svg"), width = 10 * 3 / 2.54, height = 10 * 5 / 2.54)
  ...
  ggsave(plot = plt, filename = str_c("ModelEvalutation/scatterplot_resid.svg"), width = 10 * 3 / 2.54, height = 10 * 5 / 2.54)
  ...
  ggsave(plot = plt, filename = str_c("ModelEvalutation/scatterplot_true_pred_2.svg"), width = 10 * 3 / 2.54, height = 10 * 5 / 2.54)
}
...
if (T) {
  ...
  zz <- pblapply(clim_data_sources, function(clim_data_source) {
    ...
    saveRDS(PR, str_c("ModelEvalutation/", "PR_", clim_data_source, ".Rdata"))
  })
  ...
  for (clim_data_source in clim_data_sources) {
    ...
    ggsave(plot = plt, str_c("ModelEvalutation/", "ModelParts_", clim_data_source, ".svg"), width = 8, height = 15 * 3)
  }
  ...
  for (clim_data_source in clim_data_sources) {
    ...
    ggsave(plot = plot(PFF2), str_c("ModelEvalutation/", "ModelProfile_", clim_data_source, ".svg"), width = 12, height = 12)
  }
}
...
if (T) {
  ...
  null <- lapply(clim_data_sources, function(clim_data_source) {
    ...
    ggsave(filename = str_c("ModelEvalutation/", "HiddenWeights_", clim_data_source, ".svg"), plot = plt, width = 12 * 2 / 2.54, height = 12 * 2 / 2.54)
